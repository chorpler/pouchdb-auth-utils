...
import { parseUri, assign, clone } from 'pouchdb-utils';
...
export { AuthError, addRoles, changePassword, changeUsername, debugerr, debuglog, debuglogemph, debugloggroup, debugloggroupend, plugin as default, deleteAdmin, deleteRoles, deleteUser, doFetch, fet, getBaseUrl, getBasicAuthHeaders, getBasicAuthHeadersFor, getComplexBaseUrl, getConfigUrl, getFullFetchURL, getMembership, getRelativeComplexUrl, getRoles, getSession, getURLWithoutSearchParams, getUser, getUsersDatabaseUrl, hasRole, logIn, logOut, makeBaseUrl, mode, nFetch, putUser, signUp, signUpAdmin };
